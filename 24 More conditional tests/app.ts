...
console.log("Inequality test with string: ", ("Microsoft" as string) != "Apple");
...
console.log("Is 32 not equal to 45? ", (32 as number) != 45);
...
console.log("Or operator test ", (4 as number) === 3 || 3 > 4);
// Atleast one condition has to be right for the output to be true.

// • Test whether an item is in a array
let countries :string[] = ['Turkey', 'Somalia', 'Sudan', 'Egypt']
